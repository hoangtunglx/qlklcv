					...
					<tbody>
						@foreach($dinhmucgiangvien as $value)
							<tr>
								...
								<td class="align-middle text-center"><a href="#sua" data-bs-toggle="modal" data-bs-target="#myModalEdit" onclick="getCapNhat('{{ $value->ID }}', '{{ $value->MaGiangVien }}',{{$value->TongDinhMuc}},'{{$value->NamHoc}}'); return false;"><i class="fal fa-edit"></i></a></td>
