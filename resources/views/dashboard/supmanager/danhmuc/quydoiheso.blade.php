...
@section('content')
	...
	<div class="card mb-0">
		...
		<div class="card-body pb-0">
			<p>
				...
				<a href="{{ route('supmanager.quydoiheso.xuat') }}" class="btn btn-success"><i class="fal fa-download"></i> Xuất ra Excel</a>
			</p>
	...
	<form action="{{ route('supmanager.quydoiheso.nhap') }}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
		@csrf
